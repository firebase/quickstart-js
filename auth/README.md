...
The Firebase auth quickstart demonstrates several methods for signing in:
 ...
 - The [Firebase email and password authentication quickstart](email.html) demonstrates using a Firebase stored email & password to authenticate - you can both create and sign in a user.
 - The [Firebase email link authentication quickstart](passwordless-email.html) demonstrates using an email address to sign-in without a password, via a link sent through email - you can both create and sign in a user.
