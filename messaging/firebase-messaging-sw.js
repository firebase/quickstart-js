...
if (!firebase.messaging.isSupported()) {
  console.debug(
    "Current browsing environment doesn't support FCM. Your FCM notifications will not be received"
  );
}
...
// Note that if you FCM message contains both "data" and "notification" payload,
// the background message handler will NOT be triggered.
