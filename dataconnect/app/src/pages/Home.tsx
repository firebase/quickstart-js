  ...
  <div className="min-h-screen flex items-center justify-center text-center text-white">
    <div className='px-4'>
      ...
      <ol className='list-decimal'>
        ...
        <li>Add https://{window.location.host}/__/auth/handler<a target="_blank" className="underline text-blue-600 hover:text-blue-800 visited:text-purple-600" href="https://pantheon.corp.google.com/apis/dashboard?"> to your list of redirect uris</a> by clicking on "Credentials" and then selecting "Web client (auto created by Google Service)", and then adding "{window.location.host}/__auth/handler" to Authorized redirect URIs
        </li>
